...
export const searchManagerCandidates = asyncHandler(async (req, res) => {
  const data = await departmentService.searchManagerCandidates(req.user, {
    keyword: req.query.keyword,
    limit: req.query.limit,
  });

  return success(res, data, "Manager candidates fetched");
});
