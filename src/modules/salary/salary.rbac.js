...
export const resolveSalaryListProcedure = (role) => resolveProcedure(SALARY_LIST_PROCEDURES_BY_ROLE, role);
export const resolveSalaryDetailProcedure = (role) => resolveProcedure(SALARY_DETAIL_PROCEDURES_BY_ROLE, role);
export const resolveSalaryUpdateProcedure = (role) => resolveProcedure(SALARY_UPDATE_PROCEDURES_BY_ROLE, role);
...
export const presentSalaryList = (role, records = []) => records.map((record) => presentSalaryRecord(role, record));
